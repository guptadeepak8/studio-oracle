    ...
    <div className="space-y-3 font-sans">
      ...
      <div className="flex items-center justify-between flex-wrap gap-2">
        ...
        <div className="flex items-center gap-2 text-xs">
          <div className="flex items-center gap-1.5 bg-[#161618] border border-[#28282b] rounded-lg px-2.5 py-1 text-zinc-300">
            <span className="h-2 w-2 rounded-full bg-[#4ade80] animate-pulse" />
            <span className="text-[11px] font-semibold text-zinc-200">
              Auto-Sync Active: {syncSchedule === "1hr" ? "Every 1 Hour" : syncSchedule === "6hr" ? "Every 6 Hours" : syncSchedule === "24hr" ? "Every 24 Hours" : "Manual Only"}
            </span>
          </div>
        </div>
      </div>
      ...
      <p className="text-xs text-zinc-500">
        Continuous background syncing and on-demand comment fetching from official YouTube trailers and Reddit discussion threads.
      </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-3 text-xs">
            ...
            <div className="space-y-1">
              ...
              <select
                ...
                className="w-full bg-[#161618] border border-[#28282b] rounded-lg px-3 py-2 text-xs text-zinc-100 focus:outline-none focus:border-[#e6fc4f] transition cursor-pointer font-sans"
              >
