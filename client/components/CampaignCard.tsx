...
import { MoreVertical, Database, Play, Square, Loader2 } from "lucide-react";
        ...
        <div className="relative">
          ...
          {showMenu && (
            <>
              ...
              <div className="absolute right-0 mt-1 bg-zinc-900 border border-zinc-800 rounded-lg py-1 w-40 shadow-xl z-20 text-xs text-zinc-350">
                <button
                  onClick={() => router.push(`/campaign/${campaign.content_id}`)}
                  className="w-full text-left px-3 py-2 hover:bg-zinc-800 transition font-medium cursor-pointer"
                >
                  Open Campaign
                </button>
                <button
                  ...
                  disabled={isToggling}
                  className="w-full text-left px-3 py-2 hover:bg-zinc-800 transition font-medium flex items-center gap-1.5 cursor-pointer"
                >
                ...
                <button
                  ...
                  className="w-full text-left px-3 py-2 hover:bg-rose-950/30 hover:text-rose-455 text-rose-500 transition font-medium cursor-pointer"
                >
                  Delete campaign
                </button>
              </div>
